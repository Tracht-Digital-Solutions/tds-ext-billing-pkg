 ...
 */
final class BillingApiDocsTest extends TestCase
{
    ...
    private static function mountedRoutes(): array
    {
        ...
        $registry = new ModuleRegistry([new BillingModule()]);
    ...
    public function testEveryEntryIsWellFormed(): void
    {
        $permissions = array_map(
            ...
            (new BillingModule())->permissions(),
        );

        foreach ((new BillingModule())->apiDocs() as $doc) {
